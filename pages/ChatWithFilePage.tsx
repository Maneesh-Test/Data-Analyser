...
export const ChatWithFilePage: React.FC<ChatWithFilePageProps> = ({ mode, navigateTo }) => {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
        ...
        const systemInstruction = `You are the Prism AI assistant. The user has uploaded a file named "${selectedFile.name}". Your task is to answer questions based *only* on the content of this file. Start by confirming that you've read the file and are ready for questions.`;
